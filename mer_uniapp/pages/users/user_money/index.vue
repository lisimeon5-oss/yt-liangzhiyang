					...
					<view class='headerCon'>
						<view class='account acea-row row-top row-between'>
							...
							<view v-show="statistics.rechargeSwitch"
								...
								class='recharge font_color'>{{$t('充值')}}</view>
						</view>
