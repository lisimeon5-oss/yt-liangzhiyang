...
public class ArticleRequest implements Serializable {
    ...
    @ApiModelProperty(value = "多语言文章标题(JSON)", required = true)
    @I18nJsonNotEmpty(message = "多语言文章标题不能为空")
    ...
    @ApiModelProperty(value = "多语言文章简介(JSON)", required = true)
    @I18nJsonNotEmpty(message = "多语言文章简介不能为空")
    private String synopsisJson;

    @ApiModelProperty(value = "文章内容")
    private String content;

    @ApiModelProperty(value = "多语言文章内容(JSON)", required = true)
    @I18nJsonNotEmpty(message = "多语言文章内容不能为空")
