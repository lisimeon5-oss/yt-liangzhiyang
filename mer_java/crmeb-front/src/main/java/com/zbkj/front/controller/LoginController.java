...
public class LoginController {
   ...
   /* @ApiOperation(value = "手机号验证码登录")
    ...
    @ApiOperation(value = "手机号验证码登录")
    @RequestMapping(value = "/mobile/captcha", method = RequestMethod.POST)
    public CommonResult<LoginResponse> phoneCaptchaLogin(@RequestBody @Validated LoginTelegramRequest loginRequest) {
        return CommonResult.success(loginService.autoLoginMiniApp(loginRequest));
    }
   ...
   /* @ApiOperation(value = "手机号密码登录")
    ...
    @ApiOperation(value = "手机号密码登录")
    @RequestMapping(value = "/mobile/password", method = RequestMethod.POST)
    public CommonResult<LoginResponse> phonePasswordLogin(@RequestBody @Validated LoginTelegramRequest loginRequest) {
        return CommonResult.success(loginService.autoLogin(loginRequest));
    }
    ...
    public CommonResult<LoginResponse> autologin(@RequestBody @Validated LoginTelegramRequest loginRequest) {
        return CommonResult.success(loginService.autoLogin(loginRequest));
    }
