...
public class MerchantOrderController {
    ...
    public CommonResult<LogisticsResultVo> getLogisticsInfo(@PathVariable(value = "invoiceId") Integer invoiceId) {
        LogisticsResultKNVo logisticsResultKNVo =  merchantOrderManagerService.getLogisticsInfoByMerchant(invoiceId);
        LogisticsResultVo vo = new LogisticsResultVo();
        vo.setNumber(logisticsResultKNVo.getNo());
        vo.setType(logisticsResultKNVo.getCom());
        List<LogisticsResultListVo> list = new ArrayList<>();
        logisticsResultKNVo.getList().forEach(logisticsResultVo -> {
            LogisticsResultListVo listVo = new LogisticsResultListVo();
            listVo.setTime(logisticsResultVo.getTime());
            listVo.setStatus(logisticsResultVo.getContent());
            list.add(listVo);
        });
        vo.setList(list);
