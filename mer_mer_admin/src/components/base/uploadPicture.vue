<template>
  <div>
    <el-tabs v-model="typeDate" @tab-click="radioChange" class="list-tabs">
      ...
      <el-tab-pane :label="$t('upload.video')" name="video"></el-tab-pane>
    </el-tabs>
                      ...
                      <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item
                            ...
                            v-if="!isAllCategory(data) && checkPermi(['merchant:category:save'])"
                            >{{ $t('upload.addCategory') }}</el-dropdown-item
                          >
                          <el-dropdown-item
                            v-if="!isAllCategory(data) && checkPermi(['merchant:category:update'])"
                            @click.native="onEdit(data.id)"
                            >{{ $t('upload.editCategory') }}</el-dropdown-item
                          >
                          <el-dropdown-item
                            v-if="!isAllCategory(data) && checkPermi(['merchant:category:delete'])"
...
export default {
  ...
  methods: {
    ...
    saveNewPic() {
      // if (!this.newPicId) {
      //   return this.$message.warning(this.translateText("请上传裁剪后的图片"));
      // }
