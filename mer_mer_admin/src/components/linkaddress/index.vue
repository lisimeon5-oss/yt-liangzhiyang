      ...
      <div class="table_box" :key="'link-picker-' + localeKey">
        ...
        <div class="right_box" v-if="currenType == 'link'">
          <div v-if="basicsListView.length">
            <div class="cont">{{ $t('linkPicker.shopPage') }}</div>
            <div class="Box">
              <div
                class="cont_box"
        ...
        <div class="right_box" v-if="currenType == 'marketing_link'">
          <div v-if="couponView.length">
            <div class="cont">{{ $t('linkPicker.coupon') }}</div>
            <div class="Box">
              <div
                class="cont_box"
                :class="currenId == item.id ? 'on' : ''"
...
export default {
  ...
  computed: {
    ...
    categoryData() {
      void this.localeKey;
      const source =
        this.fromType === 'printreceipt' ? [...listData.data].slice(0, -1) : [...listData.data];
