<template>
  <div class="divBox">
    <el-dialog v-if="dialogVisible" :title="$t('product.productInfo')" :visible.sync="dialogVisible" width="540px" class="dialog-bottom">
      <div v-loading="loading">
        <div class="box-container">
          ...
          <div class="dialog-footer">
            ...
            <el-button size="small" type="primary" @click="handleSort">{{ $t('common.confirmPrefix') }}</el-button>
          </div>
        </div>
      </div>
    </el-dialog>
