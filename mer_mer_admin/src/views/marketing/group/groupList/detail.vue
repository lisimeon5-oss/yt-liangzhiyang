    ...
    <el-drawer :visible.sync="dialogVisible" :direction="direction" size="1000px" :before-close="handleClose">
      <div>
        <div class="detailHead">
          ...
          <ul class="list">
            <li class="item">
              <div class="title">{{ $t('marketing.groupStatus') }}</div>
              <div
                class="titleStatus"
            ...
            <li class="item">
              <div class="title">{{ $t('marketing.groupStartTime') }}</div>
              <div>{{ data.createTime }}</div>
            </li>
            <li class="item">
              <div class="title">{{ $t('formGenerator.endTime') }}</div>
        ...
        <div class="table-box detailHead">
          <el-table :data="data.memberDataList" class="mt20 orderDetailList" size="small">
            ...
            <el-table-column :label="$t('user.userInfoTab')" min-width="140">
              <template slot-scope="scope">
                <div class="acea-row">
