  ...
  methods: {
    setConfig(data) {
      ...
      if (data) {
        ...
        if (!this.configObj.richText) {
          this.$set(this.configObj, 'richText', { val: '', valJson: '' });
        } else if (!Object.prototype.hasOwnProperty.call(this.configObj.richText, 'valJson')) {
          this.$set(this.configObj.richText, 'valJson', '');
        }
      }
    },
  },
