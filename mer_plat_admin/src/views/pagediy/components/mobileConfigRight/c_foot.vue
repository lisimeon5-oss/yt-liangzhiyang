      ...
      <div class="box-item" v-for="(item, index) in configData.list" :key="index">
        ...
        <div class="right-wrapper">
          ...
          <div class="c_row-item mb10">
            <el-col class="label" :span="4"> {{ $t('category.name') }} </el-col>
          ...
          <div class="c_row-item">
            ...
            <el-col :span="19" class="slider-box">
              <div @click="getLink(index)">
                <el-input size="small" icon="ios-arrow-forward" v-model="item.link" readonly :placeholder="$t('application.pleaseSelectLink')">
...
export default {
  ...
  methods: {
    ...
    deleteMenu(index) {
      this.$confirm(this.$t('pagediy.deleteMenuConfirm'), this.$t('el.messagebox.title'), {
