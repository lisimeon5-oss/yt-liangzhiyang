...
export default {
  ...
  computed: {
    ...
    titlePlaceholder() {
      ...
      return this.$t('pagediy.inputTabTextInLang', { lang: this.activeLangLabel });
    },
  },
  mounted() {
    this.getList();
