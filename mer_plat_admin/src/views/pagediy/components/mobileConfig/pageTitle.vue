    ...
    <div v-if="actived === 1">
      ...
      <div class="c_row-item" v-if="colorRadio === '1'">
        ...
        <div class="slider-box acea-row row-between row-middle">
          ...
          <span class="resetBtn" @click="resetBgB">{{ $t('el.table.resetFilter') }}</span>
        </div>
      </div>
      ...
      <div class="c_row-item">
        ...
        <div class="slider-box acea-row row-between row-middle">
          ...
          <span class="resetBtn" @click="resetBgA">{{ $t('el.table.resetFilter') }}</span>
        </div>
      </div>
      <div class="c_row-item">
...
export default {
  ...
  data() {
    return {
      ...
      defaultConfig: {
        titleCent: {
          tabTitle: this.$t('product.basicSetting'),
        },
        titleColor: {
  ...
  computed: {
    ...
    titlePlaceholder() {
      ...
      return this.$t('pagediy.inputPageTitleInLang', { lang: this.activeLangLabel });
    },
  },
  watch: {
    titleTxt(val) {
