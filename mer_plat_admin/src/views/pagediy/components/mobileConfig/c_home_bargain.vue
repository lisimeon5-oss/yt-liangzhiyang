...
import homeBargainPage from '../mobilePage/home_bargain.vue';
...
export default {
  ...
  watch: {
    ...
    'configObj.setUp.tabVal': {
      handler(nVal, oVal) {
        ...
        if (nVal == 0) {
          let tempArr = [
            { components: toolCom.c_input_number, configNme: 'countConfig' },
            {
  ...
  methods: {
    ...
    loadConfig(nVal) {
      ...
      this.configObj = applyDiyUiLabels(value, Object.assign({}, homeBargainPage, { num: nVal }));
    },
    getConfig(data) {
